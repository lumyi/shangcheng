(function () {
    $.ajax({
        ...
        <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="${p1.pic}">
      </div>`
        ...
        <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="${p2.pic}">
      </div>`;
    ...
    <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]"src="${p3.pic}">
  </div>`
        div3=div2.parentElement.nextElementSibling.children[0];div3.innerHTML = html;
        ...
        div3.nextElementSibling.children[0].innerHTML=html;
